...
- Bars/handbook: [`../Testing-handbook.md`](../Testing-handbook.md) · coverage [`../docs/governance/benchmarks.md`](../docs/governance/benchmarks.md) · tech-docs lane [`../tech-docs-generator/README.md`](../tech-docs-generator/README.md).
...
- Fast gate (dev loop): `pnpm run gate:fast` (or `pnpm run release:gate:fast`)
- Full ship gate (release bar): `pnpm run gate` (or `pnpm run release:gate`)
