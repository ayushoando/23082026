...
export const PRODUCTS_HERO_IMAGE = {
  ...
  alt: "Titan office workstations installed by One and Only",
} as const;
...
export const PRODUCTS_INTRO_IMAGE = {
  ...
  alt: "Seating from One and Only workplace photography",
} as const;
...
> = {
  seating: {
    ...
    alt: "Seating from the One and Only product catalog",
  },
  workstations: {
  ...
  tables: {
    ...
    alt: "Tables from the One and Only product catalog",
  },
  storages: {
    src: PRODUCTS_CATEGORY_TILE_FALLBACKS.storages,
    alt: "Storage from the One and Only product catalog",
  },
  "soft-seating": {
    src: PRODUCTS_CATEGORY_TILE_FALLBACKS["soft-seating"],
    alt: "Soft seating from the One and Only product catalog",
  },
  education: {
    src: PRODUCTS_CATEGORY_TILE_FALLBACKS.education,
    alt: "Education furniture from the One and Only product catalog",
  },
};
