...
export const SITE_ROUTE_CLASSIFICATION: SiteRouteMeta[] = [
  ...
  },
  {
    ...
    classification: "redirect",
    audience: "Public visitor / buyer",
    intent: "Consolidated into products catalog",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/products"),
    primaryAction: "Redirect to /products",
    indexable: false,
    notes: "Consolidated into /products; next.config permanent 308 redirect.",
  },
  {
    route: "/solutions/[category]",
    classification: "redirect",
    audience: "Public visitor / buyer",
    intent: "Consolidated into products category",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/products/[category]"),
    primaryAction: "Redirect to /products/[category]",
    indexable: false,
    notes: "Consolidated into /products/:category; next.config permanent 308 redirect.",
  },
  {
    route: "/planning",
    classification: "public",
  ...
  },
  {
    ...
    classification: "redirect",
    audience: "Public visitor / buyer",
    intent: "Legacy brochure path redirected to /",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/"),
    primaryAction: "Redirect home",
    indexable: false,
    notes: "Redirects to /; next.config permanent 308 only (no page shell).",
  },
  {
    route: "/download-brochure",
    classification: "redirect",
    audience: "Public visitor / buyer",
    intent: "Legacy brochure download path redirected to /",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/"),
    primaryAction: "Redirect home",
    indexable: false,
  ...
  },
  {
    ...
    classification: "redirect",
    audience: "Public visitor",
    intent: "Retired hollow newsroom → /",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/"),
    primaryAction: "Redirect home",
    indexable: false,
    notes: "Retired newsroom; next.config permanent 308 to / (no page shell).",
  },
  {
    route: "/gallery",
    classification: "redirect",
    ...
    indexable: false,
    notes: "Portfolio is the single proof photo surface; next.config permanent 308 only.",
  },
  {
    route: "/compare",
    classification: "public",
  ...
  },
  {
    ...
    classification: "public",
    audience: "Public visitor / buyer",
    intent: "Photography-forward portfolio of executed workplace projects",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/portfolio"),
  ...
  },
  {
    ...
    classification: "public",
    audience: "Public visitor / buyer",
    intent: "Curated directory of verified client organisations furnished across India",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/clients"),
    primaryAction: "Browse clients",
    indexable: true,
  },
  {
    route: "/projects",
    classification: "redirect",
    audience: "Public visitor / buyer",
    intent: "Legacy projects URL → /portfolio",
    owner: "Marketing",
    canonicalUrl: canonicalFor("/portfolio"),
    primaryAction: "Redirect to portfolio",
    indexable: false,
    notes: "Renamed to /portfolio; next.config permanent 308 only.",
  },
  {
    route: "/tracking",
    classification: "redirect",
  ...
  },
  {
    ...
    classification: "redirect",
    audience: "Public visitor",
    intent: "Legacy catalog path redirected to /",
    owner: "Site",
    canonicalUrl: canonicalFor("/"),
    primaryAction: "Redirect home",
    indexable: false,
    notes: "Permanent 308 to / via next.config only (no page shell).",
  },
  {
    route: "/portal",
