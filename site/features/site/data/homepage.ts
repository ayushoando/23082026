...
export const HOMEPAGE_HERO_IMAGES = [
  {
    ...
    alt: "DMRC office workstations installed by One and Only",
  },
  { src: "/assets/marketing/hero/slides/TVS-Oneandonly-bright.webp", alt: "TVS Motors regional office fit-out by One and Only" },
  { src: "/assets/marketing/hero/slides/TVS2-Oneandonly-bright.webp", alt: "TVS Motors workspace installation by One and Only" },
  { src: "/assets/marketing/hero/slides/TVS3-Oneandonly-bright.webp", alt: "TVS Motors enterprise fit-out by One and Only" },
  { src: "/assets/marketing/hero/slides/Titan-Oneandonly-bright.webp", alt: "Titan corporate workspace by One and Only" },
  { src: "/assets/marketing/hero/slides/Titan2-Oneandonly-bright.webp", alt: "Titan collaborative office by One and Only" },
  { src: "/assets/marketing/hero/slides/Usha-Oneandonly-bright.webp", alt: "Usha Workspace collaboration zones by One and Only" },
] as const;
...
export const HOMEPAGE_HERO_CONTENT = {
  ...
  /** Primary path: planner marketing landing. Action+outcome (Phase 1 M2). */
  primaryCta: {
    label: "Get your layout plan",
    href: "/planner",
  },
...
export const HOMEPAGE_CONTACT_CONTENT = {
  ...
  image: {
    ...
    alt: "Corporate workspace installed by One and Only",
  },
  directActions: [
    {
      type: "whatsapp",
...
/** Legacy ribbon data only — banner is not mounted on homepage. One and Only branding only. */
export const HOMEPAGE_PARTNERSHIP_CONTENT = {
  image: {
    src: "/logo.webp",
    alt: "One and Only",
  },
  title: ["One and Only", "Office Furniture"],
} as const;
