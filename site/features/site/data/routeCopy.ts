...
export const TRUSTED_BY_PAGE_COPY = {
  ...
  craftAttribution: "Delivery perspective, One and Only programmes",
  rosterKicker: "Client roster",
...
export const CLIENTS_PAGE_COPY = {
  ...
  emptyDescription:
    "Installation photos are being prepared. Browse selected client proof or contact the team.",
  contactCta: "Contact us",
  trustedCta: "View selected clients",
  selectedClientsKicker: "Selected clients",
  selectedClientsTitle: "A considered selection of client organisations.",
  selectedClientsDescription:
    "A curated set of verified marks complements the installation work shown above. This is not an exhaustive public directory.",
...
/** Canonical curated proof selection; the full identity universe lives in clientRegistry.ts. */
export const CLIENTS_PAGE_CLIENTS: ClientBadgeData[] = TRUSTED_BY_CLIENTS;
...
export const SHOWROOMS_PAGE_COPY = {
  ...
  heroTitleAccent: "us.",
  heroSubtitle:
    "One and Only Furniture showroom in Patna — hours, directions, and signature deliveries from Jagat Trade Centre, Frazer Road.",
  craftQuote:
    "See seating, finishes, and systems in context — then brief the planning team with clarity.",
  craftAttribution: "One and Only · Jagat Trade Centre · Frazer Road, Patna",
...
export const SUSTAINABILITY_PAGE_COPY = {
  ...
  craftAttribution: "Specification perspective, One and Only planning",
...
export const CAREER_PAGE_COPY = {
  ...
  craftAttribution: "People · One and Only",
...
export const PLANNING_PAGE_COPY = {
  ...
  craftAttribution: "Planning desk · One and Only",
...
export const SERVICE_PAGE_COPY = {
  ...
  craftAttribution: "Service desk · One and Only",
...
export const LEGAL_PAGE_COPY = {
  privacy: {
    ...
    intro: [
      "One and Only is operated by One and Only Furniture Private Limited (\"OOFPL\"). This policy explains what personal data we collect, how we use it, and what cookies we set when you browse our website or submit an enquiry.",
  ...
  terms: {
    ...
    heroSubtitle:
      "Website, enquiry, quotation, delivery, warranty, and support terms for One and Only office furniture across India.",
    ...
    sections: [
      {
        ...
        body: "These Terms and Conditions govern the use of this website and all commercial dealings with One and Only, including product enquiries, quotations, supply, and support services.",
      },
      {
        heading: "1. Scope",
  ...
  imprint: {
    title: "Imprint",
    heroSubtitle:
      "Business identity, representative details, and official contact information for One and Only.",
