              ...
              <div className="pdp-summary-panel mt-7" data-pdp-scroll-reveal>
                    ...
                    <dl className="pdp-summary-grid">
                      {primarySummaryCards.map((card) => (
                        <div
                          ...
                          data-pdp-scroll-reveal
                        >
                          <dt className="pdp-card-label mb-1.5">
                            {card.label}
                          </dt>
                          <dd className="text-sm leading-relaxed text-strong font-medium m-0">
                            {card.value}
                          </dd>
                        </div>
                      ))}
                ...
                {secondarySummaryCards.length > 0 ? (
                  <dl className="mt-4 flex flex-wrap gap-2">
                    {secondarySummaryCards.map((card) => (
                      ...
                      >
                        <dt className="font-semibold text-strong inline">
                          {card.label}:
                        </dt>{" "}
                ...
                {assuranceCards.length > 0 ? (
                  <div className="mt-5 border-t border-soft pt-5">
                    ...
                    <dl className="pdp-assurance-grid">
