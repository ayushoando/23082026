...
-- rollback
-- drop index if exists public.idx_image_assets_created_by;
-- drop index if exists public.idx_block_themes_created_at;
-- drop index if exists public.idx_block_themes_name;
-- drop index if exists public.customer_queries_status_created_at_idx;
-- drop index if exists public.customer_queries_source_idx;
-- drop index if exists public.idx_business_stats_history_changed_at;
-- drop index if exists public.idx_business_stats_history_business_stats_id;
-- drop index if exists public.idx_configurator_products_category_active;
-- drop index if exists public.idx_configurator_products_created_at;
-- drop index if exists public.idx_configurator_products_family;
-- drop index if exists public.idx_catalog_product_slug_aliases_created_at;
-- recreate the specs FK index this file dropped
-- create index if not exists catalog_product_specs_product_id_idx on public.catalog_product_specs (product_id);
-- drop index if exists public.idx_catalog_product_images_created_at;
-- drop index if exists public.idx_catalog_products_series_created_at;
-- drop index if exists public.idx_catalog_products_category_subcategory;
-- drop index if exists public.idx_catalog_products_category_created_at;
-- drop index if exists public.idx_catalog_products_performance_tier;
-- drop index if exists public.idx_catalog_products_series_name;
-- drop index if exists public.idx_catalog_products_series_id;
-- drop index if exists public.idx_catalog_products_created_at;
