...
-- drop policy if exists "planner_managed_products service write" on public.planner_managed_products;
-- drop policy if exists "planner_managed_products public read active" on public.planner_managed_products;
-- drop trigger if exists trg_planner_managed_products_updated_at on public.planner_managed_products;
-- drop function if exists public.touch_planner_managed_products_updated_at();
-- drop index if exists idx_planner_managed_products_updated_at;
-- drop index if exists idx_planner_managed_products_category;
-- drop index if exists idx_planner_managed_products_active;
-- drop table if exists public.planner_managed_products;
