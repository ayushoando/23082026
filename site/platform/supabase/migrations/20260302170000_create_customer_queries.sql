...
-- rollback
-- alter publication supabase_realtime drop table if exists public.customer_queries;
-- drop policy if exists customer_queries_update_service on public.customer_queries;
-- drop policy if exists customer_queries_select_service on public.customer_queries;
-- drop policy if exists customer_queries_insert_public on public.customer_queries;
-- drop trigger if exists customer_queries_set_updated_at on public.customer_queries;
-- drop function if exists public.touch_customer_queries_updated_at();
-- drop index if exists customer_queries_phone_idx;
-- drop index if exists customer_queries_email_idx;
-- drop index if exists customer_queries_created_at_idx;
-- drop index if exists customer_queries_status_idx;
