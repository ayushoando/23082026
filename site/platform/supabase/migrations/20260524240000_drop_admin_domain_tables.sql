...
-- Undo: restore public.plan_comments, public.plan_shares, public.plan_versions,
-- public.plans, public.quotes, public.projects, public.clients,
-- public.team_members, public.invites, public.offices, public.teams,
-- public.user_history, public.profiles, public.users, public.customer_queries
-- from backups/pre-split-products-*.sql (see header). Do not invent schemas here.
