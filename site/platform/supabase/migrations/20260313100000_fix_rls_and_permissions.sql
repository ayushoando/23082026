...
-- drop policy if exists "Allow public read access to catalog_categories" on public.catalog_categories;
-- drop policy if exists "Allow public read access to catalog_products" on public.catalog_products;
-- revoke all privileges on public.business_stats_history from service_role;
-- revoke select on public.business_stats_history from anon, authenticated;
-- revoke all privileges on public.business_stats_current from service_role;
-- revoke select on public.business_stats_current from anon, authenticated;
-- revoke all privileges on public.catalog_product_slug_aliases from service_role;
-- revoke select on public.catalog_product_slug_aliases from anon, authenticated;
-- revoke all privileges on public.catalog_product_images from service_role;
-- revoke select on public.catalog_product_images from anon, authenticated;
-- revoke all privileges on public.catalog_product_specs from service_role;
-- revoke select on public.catalog_product_specs from anon, authenticated;
-- revoke all privileges on public.catalog_categories from service_role;
-- revoke select on public.catalog_categories from anon, authenticated;
-- revoke all privileges on public.catalog_products from service_role;
