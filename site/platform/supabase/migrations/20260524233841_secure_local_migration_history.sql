...
-- rollback
-- drop policy if exists "_local_migration_history_service_role_all" on public._local_migration_history;
-- alter table public._local_migration_history disable row level security;
