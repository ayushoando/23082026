...
-- rollback
-- alter function public.touch_planner_managed_products_updated_at() reset search_path;
-- alter function public.touch_feature_flags_updated_at() reset search_path;
-- alter function public.touch_configurator_products_updated_at() reset search_path;
-- alter table public.block_themes disable row level security;
