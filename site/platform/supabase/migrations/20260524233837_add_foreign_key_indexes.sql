...
-- drop index if exists public.offices_team_id_idx;
-- drop index if exists public.offices_created_by_idx;
-- drop index if exists public.invites_team_id_idx;
...
-- drop index if exists public.catalog_product_images_product_id_idx;
