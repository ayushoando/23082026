...
-- rollback
-- drop policy if exists plan_shares_service_role_all on public.plan_shares;
-- drop policy if exists plan_comments_service_role_all on public.plan_comments;
-- drop policy if exists plan_versions_service_role_all on public.plan_versions;
...
-- drop policy if exists catalog_items_service_write on public.catalog_items;
-- drop policy if exists catalog_items_public_read on public.catalog_items;
-- alter table if exists public.plan_shares disable row level security;
-- alter table if exists public.plan_comments disable row level security;
-- alter table if exists public.plan_versions disable row level security;
-- alter table if exists public.plans disable row level security;
-- alter table if exists public.offices disable row level security;
...
-- alter table if exists public.user_history disable row level security;
-- alter table if exists public.users disable row level security;
-- alter table if exists public.profiles disable row level security;
-- alter table if exists public.projects disable row level security;
-- alter table if exists public.quotes disable row level security;
-- alter table if exists public.clients disable row level security;
-- alter table if exists public.customer_queries disable row level security;
-- alter table if exists public.business_stats_history disable row level security;
-- alter table if exists public.business_stats_current disable row level security;
...
-- alter table if exists public.catalog_product_slug_aliases disable row level security;
-- alter table if exists public.catalog_products disable row level security;
-- alter table if exists public.catalog_categories disable row level security;
-- alter table if exists public.catalog_product_specs disable row level security;
-- alter table if exists public.catalog_product_images disable row level security;
