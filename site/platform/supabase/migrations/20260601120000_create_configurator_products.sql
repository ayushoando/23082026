...
-- rollback
-- drop policy if exists "configurator_products public read active" on public.configurator_products;
-- drop trigger if exists trg_configurator_products_updated_at on public.configurator_products;
-- drop function if exists public.touch_configurator_products_updated_at();
-- drop index if exists idx_configurator_products_active;
-- drop index if exists idx_configurator_products_category;
-- drop table if exists public.configurator_products;
