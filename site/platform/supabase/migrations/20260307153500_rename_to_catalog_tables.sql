...
-- alter index if exists public.idx_catalog_product_slug_aliases_active_canonical rename to idx_product_slug_aliases_active_canonical;
-- alter index if exists public.idx_catalog_product_slug_aliases_active_alias rename to idx_product_slug_aliases_active_alias;
-- alter index if exists public.idx_catalog_product_images_lookup rename to idx_product_images_lookup;
-- alter index if exists public.idx_catalog_product_images_unique rename to idx_product_images_unique;
-- alter index if exists public.idx_catalog_product_specs_source rename to idx_product_specs_source;
-- alter index if exists public.idx_catalog_products_category_id rename to idx_products_category_id;
-- alter index if exists public.idx_catalog_products_category rename to idx_products_category;
-- alter index if exists public.idx_catalog_products_slug rename to idx_products_slug;
-- alter table if exists public.catalog_product_slug_aliases rename to product_slug_aliases;
-- alter table if exists public.catalog_product_images rename to product_images;
-- alter table if exists public.catalog_product_specs rename to product_specs;
-- alter table if exists public.catalog_categories rename to categories;
-- alter table if exists public.catalog_products rename to products;
