...
-- rollback
-- drop view if exists public.product_canonical_slug_v2_collisions;
-- drop trigger if exists trg_set_product_canonical_fields on public.catalog_products;
-- drop trigger if exists trg_set_product_canonical_fields on public.products;
-- drop index if exists public.idx_catalog_products_canonical_slug_v2;
-- drop index if exists public.idx_products_canonical_slug_v2;
-- drop index if exists public.idx_catalog_products_canonical_subcategory_id;
-- drop index if exists public.idx_products_canonical_subcategory_id;
-- drop index if exists public.idx_catalog_products_canonical_category_id;
-- drop index if exists public.idx_products_canonical_category_id;
-- drop index if exists public.idx_catalog_categories_canonical_id;
-- drop index if exists public.idx_categories_canonical_id;
-- alter table if exists public.catalog_products
--   drop column if exists canonical_series_id,
--   drop column if exists canonical_slug_v2,
--   drop column if exists canonical_subcategory_label,
--   drop column if exists canonical_subcategory_id,
...
--   drop column if exists canonical_subcategory_id,
--   drop column if exists canonical_category_id;
-- alter table if exists public.catalog_categories drop column if exists canonical_id;
-- alter table if exists public.categories drop column if exists canonical_id;
-- drop function if exists public.set_product_canonical_fields();
-- drop function if exists public.compute_catalog_series_id(text, text, text);
-- drop function if exists public.compute_catalog_slug_v2(text, text, text);
-- drop function if exists public.catalog_subcategory_label(text, text);
-- drop function if exists public.normalize_catalog_subcategory_id(text, text, text, jsonb);
-- drop function if exists public.normalize_catalog_category_id(text);
-- drop function if exists public.catalog_slugify_token(text);
