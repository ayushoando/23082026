...
-- drop policy if exists user_history_select_service on public.user_history;
-- drop trigger if exists user_history_set_updated_at on public.user_history;
-- drop function if exists public.touch_user_history_updated_at();
-- drop index if exists user_history_viewed_products_gin_idx;
-- drop index if exists user_history_updated_at_idx;
