...
-- rollback
-- alter function public.capture_business_stats_history() reset search_path;
-- alter function public.catalog_slugify_token(source_value text) reset search_path;
-- alter function public.catalog_subcategory_label(source_category_id text, source_subcategory_id text) reset search_path;
-- alter function public.compute_catalog_series_id(source_category_id text, source_subcategory_id text, source_series_name text) reset search_path;
-- alter function public.compute_catalog_slug_v2(source_category_id text, source_subcategory_id text, source_name text) reset search_path;
-- alter function public.compute_normalized_product_name_key(source_name text) reset search_path;
-- alter function public.handle_new_user() reset search_path;
-- alter function public.normalize_catalog_category_id(source_category_id text) reset search_path;
-- alter function public.normalize_catalog_subcategory_id(source_category_id text, source_subcategory_label text, source_product_name text, source_metadata jsonb) reset search_path;
-- alter function public.set_product_canonical_fields() reset search_path;
-- alter function public.set_products_normalized_name_key() reset search_path;
-- alter function public.touch_customer_queries_updated_at() reset search_path;
-- alter function public.touch_product_images_updated_at() reset search_path;
-- alter function public.touch_product_slug_aliases_updated_at() reset search_path;
-- alter function public.touch_product_specs_updated_at() reset search_path;
-- alter function public.touch_user_history_updated_at() reset search_path;
