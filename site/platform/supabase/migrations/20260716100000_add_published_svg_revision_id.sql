...
-- rollback
-- drop index if exists idx_planner_managed_products_published_svg_revision_id;
-- comment on column public.planner_managed_products.published_svg_revision_id is null;
-- alter table public.planner_managed_products drop column if exists published_svg_revision_id;
