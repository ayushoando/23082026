...
import {
  ...
  staggerContainer,
  staggerItem,
  useHydrationStableReducedMotion,
...
export function PlannerToolsShowcase({
  ...
  secondaryCta,
  demoHref = "/ooplanner",
  demoAriaLabel = "Open interactive floor plan demo: Example 10 by 8 metre office layout, launch planner",
  ...
  const motionReduced = reduceMotion === true;
            ...
            <motion.div variants={staggerItem} className="space-y-3">
              {isHomepage && kicker ? (
                <motion.div
                  ...
                  animate={motionReduced ? undefined : { opacity: [0.72, 1, 0.72] }}
              ...
              {isLanding ? (
                ...
                <motion.div
                  variants={motionReduced ? undefined : cardHover}
                  initial="rest"
                  whileHover={motionReduced ? undefined : "hover"}
                  className="mt-8"
                >
                  <PrimaryCtaLink
                    href={primaryCta.href}
                  ...
                  >
                    <div className="home-tool-card__body">
                      ...
                      <span className="home-tool-link home-tool-link--dark typ-cta">
                        {primaryCta.label}
                        <motion.span
                          variants={motionReduced ? undefined : ctaArrow}
                          initial="rest"
