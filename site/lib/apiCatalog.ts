...
export const DISK_API_ROUTES: readonly ApiCatalogEntry[] = [
  ...
  { path: "/api/Planner/projects", summary: "Planner projects collection", methods: ["get", "post", "put", "delete", "patch"] },
  { path: "/api/Planner/projects/{id}", summary: "Planner project document", methods: ["get", "patch", "delete", "post", "put"] },
  { path: "/api/Planner/handoff", summary: "Planner BOQ handoff", methods: ["post", "get", "put", "delete", "patch"] },
  { path: "/api/Planner/catalog", summary: "Planner catalog read", methods: ["get", "post", "put", "delete", "patch"] },
  { path: "/api/Planner/catalog/upload", summary: "Planner catalog upload", methods: ["post", "get", "put", "delete", "patch"] },
  { path: "/api/Planner/sketch-to-plan", summary: "Planner sketch-to-plan", methods: ["post", "get", "put", "delete", "patch"] },
  { path: "/api/Planner/ai-advisor", summary: "Planner AI advisor", methods: ["post", "get", "put", "delete", "patch"] },
