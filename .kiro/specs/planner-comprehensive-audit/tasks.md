...
- [ ] 1. Workstream 1 — Maintain audit foundation, findings, and serial reconciliation
  ...
  - [~] 1.8 Re-run static inventory/trace reconciliation and dispatch every remaining verified repository defect to its exclusive owner
  ...
  - [~] 1.9 Finalize the coverage/evidence matrix and finding classifications
  ...
  - [~] 1.10 Generate the final completion record with strict lane separation
...
- [~] 2. Workstream 2 — Remediate fork, geometry, and persistence integrity
  ...
  - [~] 2.8 Implement atomic revision compare-and-swap behavior
