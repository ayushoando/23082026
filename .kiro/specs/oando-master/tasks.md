...
- [ ] 1. Reconcile the canonical Oando Master Skill contract
  ...
  - [-] 1.4 Wire the completion and reporting contract together in `.kiro/skills/oando-master/SKILL.md`
...
- [~] 2. Checkpoint - Ensure documentation reconciliation is coherent
