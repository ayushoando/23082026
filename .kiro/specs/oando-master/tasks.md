...
- **Shared future fixture path:** `./.kiro/specs/oando-master/tests/oando-master-properties.test.ts`, only after explicit owner-approved test/check scope. Current guide and router files are read-only fixtures.
...
Check the 13 fields in order, specialized-term explanation, missing-proof state, validation state, next owner, and pre/post verification records.
  ...
  - [x] 10.5 Property 5: Complete safe Prompt Cookbook
