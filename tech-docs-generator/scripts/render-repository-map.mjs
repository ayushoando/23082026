...
const MAP_REL = 'generated-documents/repository-map'
const GRAPH_REL = 'generated-documents/repository-graph'
 ...
 * generated-documents/repository-graph/. Missing artifacts render as explicit
...
function collectGraphFacts(repoRoot) {
  ...
  const topFanIn = (stats?.highestFanIn ?? [])
    .slice(0, 3)
...
<body>
  <header>
    ...
    <p class="subtitle">A beginner-readable map of the Next.js product, Planner and Studio forks, data ownership, tooling, and fresh static graph evidence. Generated by <code>tech-docs-generator/scripts/render-repository-map.mjs</code> — edit the generator, not this page.</p>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <section id="overview">
        <h2>Overview</h2>
        <p class="lead">The repository is a root-managed pnpm workspace containing one main Next.js application, a separate tech-docs Vite SPA, a Cloudflare Worker, and test and operations tooling.</p>
        <div class="grid">
...
├─ generated-documents/          generated tech-doc output, map, and graph reports
...
└─ package.json                  root scripts and all product dependencies</pre>
      ...
      <section id="classification">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>Local / private</td><td><code>.env.local</code>, <code>site/.env.local</code>, <code>node_modules/</code>, <code>.git/</code>, <code>.vscode/</code></td><td>Keep secrets private and do not edit generated tool state.</td></tr>
  ...
  → Admin DB, Products DB, or approved dev disk</pre>
      ...
      <section id="boundaries">
        ...
        <div class="callout">Highest fan-in files right now: ${facts.topFanIn || '<span class="warning-text">not yet generated</span>'}. Changes there ripple the widest; review impact with <code>tech-docs-generator/scripts/graph-impact.mjs --file=&lt;path&gt;</code>.</div>
      </section>
      ...
      <section id="graph">
        ...
        <table>
          ...
          <tbody>
            <tr><td>Whole import graph</td><td><code>generated-documents/repository-graph/stats/latest.json</code></td><td>${factValue(facts, 'files')} files, ${factValue(facts, 'edges')} edges, ${factValue(facts, 'unresolved')} unresolved local references.</td></tr>
            <tr><td>Cycle report</td><td><code>generated-documents/repository-graph/cycles/latest.json</code></td><td>${factValue(facts, 'cycleCount')} strongly connected local-import groups.</td></tr>
            <tr><td>Page/component graph</td><td><code>generated-documents/repository-graph/page-components/</code></td><td>${factValue(facts, 'routes')} routes, ${factValue(facts, 'pageNodes')} nodes, ${factValue(facts, 'pageEdges')} edges.</td></tr>
            ...
            <tr><td>Blast-radius reports</td><td><code>generated-documents/repository-graph/impact/</code></td><td>Top fan-in files, wiped and rewritten on every generator run.</td></tr>
          </tbody>
        </table>
        <p class="small">Page graph content hash: <code>${escapeHtml(facts.pageGraphGeneratedAt ?? 'not yet generated')}</code>. Graph reports are generated into <code>generated-documents/repository-graph/</code> and wiped on every generator run.</p>
      </section>
      ...
      <section id="limitations">
        ...
        <ul>
          ...
          <li>The generic repository convention describes <code>results/</code> as generated evidence, but graph reports are generated into <code>generated-documents/repository-graph/</code>.</li>
        </ul>
      </section>
      ...
      <section id="next">
        ...
        <div class="two-col">
          <div>
            <h3>Read first</h3>
            <div class="path-list"><code>START.md</code><code>AGENTS.md</code><code>README.md</code><code>package.json</code><code>Agents/INDEX.md</code><code>generated-documents/repository-map/index.html</code></div>
          </div>
          <div>
...
tests/unit/planner/</pre>
  ...
  <footer>
    <p><strong>Report status:</strong> generated by tech-docs-generator/scripts/render-repository-map.mjs from repository facts and graph evidence under <code>generated-documents/repository-graph/</code>. Edit the generator, not this page.</p>
    <p>Canonical references: <code>START.md</code>, <code>AGENTS.md</code>, and <code>docs/architecture/</code>.</p>
  </footer>
