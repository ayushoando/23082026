# Shallow history: one commit, private ayushoando/oando1408, no prior remote history
...
$repoCreated = $false
gh repo view ayushoando/oando1408 2>&1 | ForEach-Object { WL $_ }
...
git -c user.name='ayushoando' -c user.email='ayush@oando.co.in' `
