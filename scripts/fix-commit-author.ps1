# Fix blank/unlinked commit author and re-push to ayushoando/oando1408
...
$author = 'ayushoando <ayush@oando.co.in>'
...
& gh auth switch -u ayushoando 2>&1 | ForEach-Object { WL $_ }
