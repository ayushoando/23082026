...
function isProductZonePath(rel) {
  return (
    ...
    rel.startsWith("features/Planner/") ||
    rel.startsWith("features/Studio/") ||
    rel.startsWith("components/Planner/") ||
    rel.startsWith("components/Studio/") ||
    rel.startsWith("app/ooplanner/") ||
    rel.startsWith("app/oostudio/") ||
