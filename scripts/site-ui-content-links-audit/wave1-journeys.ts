...
function makeJourneyRecord(
  ...
  return {
    ...
    payload: {
      ...
      accessContextsRequired: options.accessContextsRequired ?? [
        "access.public-guest",
      ],
    },
...
export function buildJourneyInventory(
  discoveredAt: string,
  ...
  // =========================================================================
  {
    ...
    const n2 = makeNode(
      ...
      "User clicks Products in the header nav.",
    );
    const n3 = makeNode(
      "action",
      "Category Browse",
    ...
    const n5 = makeNode(
      ...
      "/quote-cart",
      "catalog-configurator",
      "User adds a product to the quote cart.",
    );
    ...
    const edges = [
      ...
      makeEdge(
        ...
        "navigation",
        "Category selection",
        "Click category card or mega menu item",
      ),
      makeEdge(
        n3.nodeId,
        n4.nodeId,
      ...
      makeEdge(
        ...
        "navigation",
        "Add to quote cart",
        "Click 'Add to cart' or 'Get Quote'",
      ),
    ];
  ...
  // =========================================================================
  {
    ...
    const n3 = makeNode(
      ...
      "/quote-cart",
      "catalog-configurator",
      "User adds product to quote cart.",
    );
    const n4 = makeNode(
      "action",
      "View Cart",
      "/quote-cart",
      "catalog-configurator",
      "User reviews quote cart contents.",
    );
    const n5 = makeNode(
      "action",
      "Contact Form",
      "/contact",
      "marketing",
      "User navigates to contact to submit quote.",
    );
    const n6 = makeNode(
      "terminal-success",
      "Quote Submitted",
      "/contact",
      "marketing",
      "User submits the enquiry/quote form.",
    );
    ...
    const edges = [
      ...
      makeEdge(
        ...
        "navigation",
        "Proceed to contact",
        "Click 'Request Quote' or 'Contact'",
        { surfaceBoundary: "catalog-configurator→marketing" },
      ),
      makeEdge(
        n5.nodeId,
        n6.nodeId,
  ...
  // =========================================================================
  {
    const n1 = makeNode(
      ...
      "/access",
      "authentication",
      "User arrives at the sign-in page.",
    );
    const n2 = makeNode(
      "action",
      "Submit Credentials",
    ...
    const n4 = makeNode(
      ...
      "/portal",
      "portal-dashboard",
      "User is redirected to portal or return-to URL after successful auth.",
    ...
    const edges = [
      ...
      makeEdge(
        ...
        "Redirect to return-to URL or /portal",
        {
          authRequired: true,
  ...
  // =========================================================================
  {
    const n1 = makeNode(
      "entry",
      "Planner Marketing Page",
      "/planner",
      "marketing",
      "User lands on the Planner marketing page.",
    );
    const n2 = makeNode(
      "action",
      "Choose Entry Mode",
      "/choose-product",
      "catalog-configurator",
      "User selects guest or authenticated planner entry.",
    );
    const n3 = makeNode(
      "action",
      "Open Planner Canvas",
      "/ooplanner",
      "planner",
      "User accesses the Planner canvas.",
    );
    const n4 = makeNode(
      "action",
      "Design Floor Plan",
      "/ooplanner",
      "planner",
      "User creates/edits the floor plan.",
    );
    const n5 = makeNode(
      "terminal-success",
      "Export/Share",
      "/ooplanner",
      "planner",
      "User exports or shares the plan.",
    ...
    const n6 = makeNode(
      ...
      "/ooplanner/projects",
      "planner",
      "User saves the plan to their projects.",
      "access.planner-member",
    );
    ...
    const edges = [
      makeEdge(
        ...
        "navigation",
        "Start Planner",
        "Click 'Start Planning' or 'Open Planner'",
      ),
      makeEdge(
        n2.nodeId,
        n3.nodeId,
      ...
      makeEdge(
        ...
        { requiresRuntime: true } as object,
      ),
      makeEdge(
        n4.nodeId,
        n6.nodeId,
    ...
    records.push(
      makeJourneyRecord(
        ...
        edges,
        {
          ...
          coverageGapReason:
            "Planner canvas actions (design, export, save) require runtime browser execution for full journey verification. Static source confirms entry and navigation edges only.",
        },
        discoveredAt,
      ),
    );
  ...
  // =========================================================================
  {
    const n1 = makeNode(
      ...
      "/portal",
      "portal-dashboard",
      "Authenticated customer accesses their portal.",
      "access.authenticated-customer",
    );
    const n2 = makeNode(
      "action",
      ...
      "/portal/[id]",
      "portal-dashboard",
      "Customer opens a specific project.",
      "access.authenticated-customer",
    );
    const n3 = makeNode(
      "action",
      ...
      "/portal/[id]",
      "portal-dashboard",
      "Customer reviews the floor plan in their portal workspace.",
      "access.authenticated-customer",
    );
    const n4 = makeNode(
      "terminal-success",
      ...
      "/portal/[id]",
      "portal-dashboard",
      "Customer approves or comments on the plan.",
      "access.authenticated-customer",
    );
    ...
    records.push(
      makeJourneyRecord(
        ...
        edges,
        {
          ...
          resultStatus: "coverage-gap",
          coverageGapReason:
            "Portal project IDs require authenticated database access to enumerate. Runtime verification is required for complete portal journey validation.",
        },
        discoveredAt,
      ),
    );
  ...
  // =========================================================================
  {
    ...
    const n2 = makeNode(
      ...
      "/products",
      "catalog-configurator",
      "User clicks a primary CTA or nav item to enter the catalog.",
    );
    ...
    const edges = [
      makeEdge(
        ...
        "surface-cross",
        "Enter catalog",
        "Click 'View Products' or Products nav",
        {
  ...
  // =========================================================================
  {
    ...
    const n2 = makeNode(
      ...
      "/access",
      "authentication",
      "Session check fails — user is redirected to /access with return path.",
    );
    const n3 = makeNode(
      "action",
      "Re-authenticate",
    ...
    const n4 = makeNode(
      ...
      "/portal",
      "portal-dashboard",
      "User is redirected back to the original protected route.",
      "access.authenticated-customer",
    );
    ...
    const edges = [
      ...
      makeEdge(
        ...
        "form-submit",
        "Re-authenticate",
        "User submits credentials on /access",
      ),
      makeEdge(
        n3.nodeId,
        n4.nodeId,
  ...
  // =========================================================================
  {
    ...
    const n2 = makeNode(
      ...
      "/contact",
      "marketing",
      "User completes the enquiry form fields.",
    );
    const n3 = makeNode(
      "action",
      "Submit Form",
    ...
    const n6 = makeNode(
      ...
      "/contact",
      "marketing",
      "Form has validation errors — user must correct and resubmit.",
    );
    ...
    const edges = [
      ...
      makeEdge(
        ...
        "conditional",
        "Validation fails",
        "Show field errors, preserve input",
      ),
      makeEdge(
        n6.nodeId,
        n2.nodeId,
  ...
  // =========================================================================
  {
    const n1 = makeNode(
      ...
      "/portal/guest",
      "portal-dashboard",
      "Guest user accesses a shared plan link.",
    );
    const n2 = makeNode(
      "action",
      "View Shared Plan",
    ...
    records.push(
      makeJourneyRecord(
        ...
        edges,
        {
          ...
          resultStatus: "coverage-gap",
          coverageGapReason:
            "Guest view IDs require shared-link tokens not available for static enumeration.",
        },
        discoveredAt,
      ),
    );
