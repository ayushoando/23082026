...
if (modules.length === 0) {
  const report = {
    ok: true,
    skipped: true,
    reason: "No *.module.css under site/focss — CSS-module graph N/A; verify-focss-structure is authoritative",
    moduleCount: 0,
    importEdgeCount: 0,
    graphHash: crypto.createHash("sha256").update("").digest("hex"),
    modulesWithImports: [],
    failures: [],
    cycles: [],
  };
