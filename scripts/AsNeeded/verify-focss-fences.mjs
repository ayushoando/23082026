...
if (plannerImportList.includes("../base/scan.css")) {
  fail("planner/entry.css must not import ../base/scan.css — own @import tailwindcss");
}
if (
  plannerImportList.some((s) =>
    ["../base/runtime.css", "../base/index.css", "../base/document.css"].includes(s),
  )
) {
  fail("planner/entry.css must not import marketing runtime/index/document");
}
