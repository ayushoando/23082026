# Create private ayushoando/oando1408 and push shallow main (fixes wrong GitHub account on push)
...
WL '=== Use ayushoando for git + gh ==='
Run-External @('gh', 'auth', 'switch', '-u', 'ayushoando')
...
$viewExit = Run-External @('gh', 'repo', 'view', 'ayushoando/oando1408') -AllowFail
if ($viewExit -ne 0) {
  Run-External @('gh', 'repo', 'create', 'ayushoando/oando1408', '--private', '--description', 'OO Studio / Planner')
...
WL 'https://github.com/ayushoando/oando1408'
