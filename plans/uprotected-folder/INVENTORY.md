# Test Inventory Census

Generated executable-test and support-file inventory. Layout rules: [`CONTENTS.md`](./CONTENTS.md). Canonical repository inventory: [`tests/INVENTORY.md`](file:///d:/23082026/tests/INVENTORY.md).

*Audited & Updated: 2026-09-05 — regenerate through the repository docs workflow (`pnpm run docs:sync`).*
