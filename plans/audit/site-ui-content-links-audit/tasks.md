...
- [x] 1.1 Establish the non-product audit foundation, schemas, adapters, discovery, profiles, matrix, manifests, and wave controls
  ...
  - **Consolidates former tasks:** 1.1–1.6. **Prerequisites:** completed requirements/design and the former external spec config (removed); no runtime authorization is required for source-level setup.
