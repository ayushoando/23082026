...
The active planning index and sequence spine are [`PLAN.md`](./PLAN.md) and [`client-hub/flowcharts/clients-hub-flow.md`](./client-hub/flowcharts/clients-hub-flow.md). The former `05092026` phased-remedy suite was retired; do not recreate or link to that deleted folder.
