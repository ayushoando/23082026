...
describe("site catalog slugResolver", () => {
  ...
  describe("canonicalCategorySlugSegment", () => {
    ...
    it("slugifies unknown categories", () => {
      ...
      expect(canonicalCategorySlugSegment("!!!")).toBe("products");
      expect(canonicalCategorySlugSegment(null)).toBe("products");
    });
  });
  ...
  describe("buildCanonicalSeriesId", () => {
    ...
    it("defaults missing series names to series", () => {
      expect(
        buildCanonicalSeriesId({
          categoryId: "tables",
          subcategoryId: "meeting",
        }),
      ).toBe("tables-meeting-series");
    });
