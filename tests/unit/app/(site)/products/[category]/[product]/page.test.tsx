...
describe('ProductPage Route', () => {
  ...
  describe('ProductPage Component', () => {
    ...
    it('redirects UUID and folder slugs to the public source slug', async () => {
      vi.mocked(resolveProductByUrlKey).mockResolvedValue(
        mockProductResolution(
          {
            id: '00d961b2-63d2-4985-8bca-f4debfba07a2',
            slug: '00d961b2-63d2-4985-8bca-f4debfba07a2',
            name: 'Crest',
            description: 'Crest executive table',
            category_id: 'tables',
            metadata: { sourceSlug: 'crest' },
          },
          '00d961b2-63d2-4985-8bca-f4debfba07a2',
        ),
      );
      ...
      await expect(
        renderProductContent({
          category: 'tables',
          product: '00d961b2-63d2-4985-8bca-f4debfba07a2',
        }),
      ).rejects.toThrow('REDIRECT:/products/tables/crest');
    });
  });
});
