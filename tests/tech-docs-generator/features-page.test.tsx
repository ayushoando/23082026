...
vi.mock("../../tech-docs-generator/src/data/featuresData", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../tech-docs-generator/src/data/featuresData")>();
  return {
    ...actual,
    otherFeatureRecords: [
      {
...
import { Features } from "../../tech-docs-generator/src/pages/Features";
