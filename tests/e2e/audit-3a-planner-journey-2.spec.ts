...
test("workflow bar — step navigation, forward-warning, validation panel", async ({ page }) => {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      `Step pills walk Draw -> Place -> Review correctly: true`,
    ].join("\n"),
  );
});
